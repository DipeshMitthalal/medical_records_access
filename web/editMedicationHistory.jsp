...
<form name="userform" method="post" action="../UpdateEditedRecords">
<br><br><br>
<input type="hidden" name="id" value="<%=id%>"/>
<table align="center" width="300px" style="background-color:#EDF6EA;border:1px solid #000000;">

<tr><td colspan=2 style="font-weight:bold;" align="center">Edit Medication Details</td></tr>
<tr><td colspan=2 align="center" height="10px"></td></tr>
	<tr>
		<td>RecordID</td>
		<td><input type="text" name="RecordID" value="<%=id%>"></td>
	</tr>
	<tr>
	...
	<tr>
		<td>patient Id</td>
                <td><input type="text" name="patID" value="<%=glucoselevel%>" readonly="readonly"></td>
	</tr>
	<tr>
		<td>PrescribedBy</td>
		<td><input type="text" name="prescribedby" value="<%=prescribedBy%>" readonly="readonly"></td>
	</tr>
